...
export const products = [
  ...
  },
  {
    ...
    company: "redmi",
    description:
      "For this model, screen size is 3.94 cm and rectangular in shape.  Special Feature includes Rate Monitor, Oxymeter (SpO2), Music Player, Camera. Anjaan baba uses it to track his heart beat 🧡, when Babita ji comes!",
    category: "smartwatch",
    isShippingAvailable: true,
    stock: 21,
    reviewCount: 508,
  ...
  },
  {
    ...
    company: "oneplus",
    description:
      "For this model, screen size is 6.7 inches and RAM Memory is 16 GB. Operating System is OxygenOS. This is a 5G device. This is Anjaan baba's favorite 🧡",
    category: "mobile",
    isShippingAvailable: true,
    stock: 22,
    reviewCount: 22031,
