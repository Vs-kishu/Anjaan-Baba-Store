...
import { LOCAL_STORAGE_KEYS, ToastType } from "../constants/constants";
import { useState } from "react";
import { signupService } from "../Services/services";
import { useAuthContext } from "../contexts/AuthContextProvider";
import useAudio from "../hooks/useAudio";
import anjaanSound from "../assets/anjaan.mp3";

const SignupPage = () => {
  const signupPageLocation = useLocation();
  const { updateUserAuth, user } = useAuthContext();
  const handleSoundPausePlay = useAudio({ audioTrack: anjaanSound });
    ...
    <LoginAndSignupLayout>
      ...
      <form onSubmit={handleCreateAccount}>
        ...
        <FormRow
          ...
          name="email"
          id="email"
          placeholder="anjaanBaba@gmail.com"
